...
#define LOG_INFO( fmt, ... ) fprintf( SIMPLE_LOGGER_DEST, SIMPLE_LOGGER_INFO_MSG fmt, ##__VA_ARGS__ )
#define LOG_ERROR( fmt, ... ) fprintf( SIMPLE_LOGGER_DEST, SIMPLE_LOGGER_ERROR_MSG fmt, ##__VA_ARGS__ )
